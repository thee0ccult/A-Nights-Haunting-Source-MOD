...
void CZombie::Precache( void )
{
	...
	PrecacheModel("models/zombie/classic2.mdl");
	PrecacheModel("models/zombie/classic3.mdl");
	PrecacheModel("models/zombie/classic4.mdl");
	PrecacheModel("models/zombie/classic5.mdl");
	PrecacheModel("models/zombie/classic6.mdl");
	PrecacheModel("models/zombie/classic7.mdl");
	PrecacheModel("models/zombie/classic8.mdl");
	PrecacheModel("models/zombie/classic9.mdl");
	PrecacheModel("models/zombie/classic10.mdl");

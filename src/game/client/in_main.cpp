...
#else
ConVar cl_sidespeed( "cl_sidespeed", "325", FCVAR_REPLICATED | FCVAR_CHEAT );
ConVar cl_upspeed( "cl_upspeed", "197", FCVAR_REPLICATED | FCVAR_CHEAT );
ConVar cl_forwardspeed( "cl_forwardspeed", "327", FCVAR_REPLICATED | FCVAR_CHEAT );
ConVar cl_backspeed( "cl_backspeed", "322", FCVAR_REPLICATED | FCVAR_CHEAT );
#endif // CSTRIKE_DLL
...
kbutton_t	in_drop; //weapondrop imp
...
void IN_DropUp(const CCommand& args) { KeyUp(&in_drop, args[1]); } /*weapon drop*/

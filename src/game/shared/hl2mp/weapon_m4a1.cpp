...
//remove grenade launcher hack// #define M4a1_GRENADE_DAMAGE 100.0f
//remove grenade launcher hack// #define M4a1_GRENADE_RADIUS 250.0f

class CWeaponM4a1 : public CHL2MPMachineGun
{
public:
	DECLARE_CLASS(CWeaponM4a1, CHL2MPMachineGun);
	...
	//remove grenade launcher hack// void	SecondaryAttack(void);
	...
	{
		static const Vector cone = VECTOR_CONE_14DEGREES;
...
//-----------------------------------------------------------------------------
// Purpose: //remove grenade launcher hack//drn0
//-----------------------------------------------------------------------------
/*void CWeaponAK47::SecondaryAttack(void)
{
	...
	pGrenade->SetDamage(AK47_GRENADE_DAMAGE);
	pGrenade->SetDamageRadius(AK47_GRENADE_RADIUS);
#endif

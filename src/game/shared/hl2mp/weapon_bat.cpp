...
//-----------------------------------------------------------------------------
ConVar sk_bat_lead_time( "sk_bat_lead_time", "0.9" );

int CWeaponBat::WeaponMeleeAttack1Condition( float flDot, float flDist )
{
	// Attempt to lead the target (needed because citizens can't hit manhacks with the crowbar!)
	...
	float dt = sk_bat_lead_time.GetFloat();
...
float CWeaponBat::GetFireRate( void )
{

...
class CWeaponGlock : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS( CWeaponGlock, CBaseHL2MPCombatWeapon );
	...
	{	
		...
		VectorLerp( VECTOR_CONE_2DEGREES, VECTOR_CONE_3DEGREES, ramp, cone );

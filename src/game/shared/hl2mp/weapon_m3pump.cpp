...
#ifdef CLIENT_DLL
#define CWeaponM3pump C_WeaponM3pump
#endif

extern ConVar sk_auto_reload_time;
extern ConVar sk_plr_num_m3pump_pellets;

class CWeaponM3pump : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS(CWeaponM3pump, CBaseHL2MPCombatWeapon);
...
private:
	CWeaponM3pump(const CWeaponM3pump&);
};

IMPLEMENT_NETWORKCLASS_ALIASED(WeaponM3pump, DT_WeaponM3pump)

BEGIN_NETWORK_TABLE(CWeaponM3pump, DT_WeaponM3pump)
#ifdef CLIENT_DLL
...
#ifdef CLIENT_DLL
BEGIN_PREDICTION_DATA(CWeaponM3pump)
...
LINK_ENTITY_TO_CLASS(weapon_m3pump, CWeaponM3pump);
PRECACHE_WEAPON_REGISTER(weapon_m3pump);

#ifndef CLIENT_DLL
acttable_t	CWeaponM3pump::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponM3pump);
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CWeaponM3pump::CWeaponM3pump(void)
{
...
// Input  : *pOperator - 
//-----------------------------------------------------------------------------
void CWeaponM3pump::FireNPCPrimaryAttack(CBaseCombatCharacter *pOperator, bool bUseWeaponAngles)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponM3pump::Operator_ForceNPCFire(CBaseCombatCharacter *pOperator, bool bSecondary)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponM3pump::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	switch (pEvent->event)
	{
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponM3pump::StartReload(void)
{
	if (m_bNeedPump)
		return false;
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponM3pump::Reload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponM3pump::FinishReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponM3pump::FillClip(void)
{
	CBaseCombatCharacter *pOwner = GetOwner();
...
//
//-----------------------------------------------------------------------------
void CWeaponM3pump::DryFire(void)
{
	WeaponSound(EMPTY);
...
//
//-----------------------------------------------------------------------------
void CWeaponM3pump::PrimaryAttack(void)
{
...
//-----------------------------------------------------------------------------
void CWeaponM3pump::ItemPostFrame(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponM3pump::ItemHolsterFrame(void)
{
	// Must be player held
...
//==================================================
/*
void CWeaponM3pump::WeaponIdle( void )
{
//Only the player fires this way so we can cast

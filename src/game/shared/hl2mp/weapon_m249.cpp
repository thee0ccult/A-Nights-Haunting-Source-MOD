...
//#define M249_GRENADE_DAMAGE 100.0f
//#define M249_GRENADE_RADIUS 250.0f

class CWeaponM249 : public CHL2MPMachineGun
{
public:
	DECLARE_CLASS(CWeaponM249, CHL2MPMachineGun);
...
/*void CWeaponM249::SecondaryAttack(void)
{
	...
	pGrenade->SetDamage(M249_GRENADE_DAMAGE);
	pGrenade->SetDamageRadius(M249_GRENADE_RADIUS);
#endif

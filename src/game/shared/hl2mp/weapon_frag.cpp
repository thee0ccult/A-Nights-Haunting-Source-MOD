...
//	vForward[0] += 0.1f;
	...
	vecThrow += vForward * 600; //was 1200 
	CBaseGrenade *pGrenade = Fraggrenade_Create( vecSrc, vec3_angle, vecThrow, AngularImpulse(600,random->RandomInt(-600,600),0), pPlayer, GRENADE_TIMER, false );

...
//	float flTimeLimit = mp_timelimit.GetFloat() * 60;
	...
	{
		UTIL_ClientPrintAll( HUD_PRINTCENTER, "All slayers ready. sLAUGHTER will restart in 5 seconds" );
		UTIL_ClientPrintAll( HUD_PRINTCONSOLE, "All slayers ready. sLAUGHTER will restart in 5 seconds" );
...
void CHL2MPRules::ClientSettingsChanged( CBasePlayer *pPlayer )
{
	...
	if ( stricmp( szModelName, pCurrentModel ) )
	{
		...
		if ( HL2MPRules()->IsTeamplay() == false )
		{
			...
			Q_snprintf( szReturnString, sizeof( szReturnString ), "Resurrected as: %s\n", pszCurrentModelName );
...
void CHL2MPRules::CheckRestartGame( void )
{
	...
	if ( iRestartDelay > 0 )
	{
		...
		UTIL_ClientPrintAll( HUD_PRINTCENTER, "sLAUGHTER HOUSE will restart in %s1 %s2", strRestartDelay, iRestartDelay == 1 ? "SECOND" : "SECONDS" );
		UTIL_ClientPrintAll( HUD_PRINTCONSOLE, "sLAUGHTER HOUSE will restart in %s1 %s2", strRestartDelay, iRestartDelay == 1 ? "SECOND" : "SECONDS" );
